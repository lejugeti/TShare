<template>
    <div class="maine">
      ...
      <div class="main">
        ...
        <div class="section displayColomn" v-if="selected === 5" >
          <div class="displayRow">
            <p>Demande de location reçue</p>
            <label class="switch">
          ...
          <div class="displayRow">
            <p>Demande de location validée par le propriétaire</p>
            <label class="switch">
              <input type="checkbox" checked>
              <span class="slider round"></span>
            </label>
        ...
        <div class="section displayColomn" v-if="selected === 6" >
          <div class="displayRow">
            <p>Autoriser T-Share à personnaliser mon fil d’actu et mes résultats de recherche en évaluant mes préférences, mes paramètres, mes locations précédentes ainsi que mon utilisation du site Web T-Share</p>
            <label class="switch">
              <input type="checkbox" checked>
              <span class="slider round"></span>
            </label>
